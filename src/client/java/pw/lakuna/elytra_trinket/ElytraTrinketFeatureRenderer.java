...
public class ElytraTrinketFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertices, int light, T entity, float limbAngle,
        ...
        VertexConsumer vertex = ItemRenderer.getArmorGlintConsumer(
            vertices, RenderLayer.getArmorCutoutNoCull(identifier), false, stack.hasGlint());
